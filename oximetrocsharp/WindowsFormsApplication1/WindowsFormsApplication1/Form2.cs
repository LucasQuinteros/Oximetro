...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        public static class Var
        {
            ...
            public static int[] X = new int[65];    //vector eje temporal
            public static int[] Y = new int[65];    //vector de valores de la señal para graficar (ver double D[])
            ...
            public static double[] D = new double[65];  //vector de valores calculados de la señal, segun la ecuacion
...
;
        ...
        void Dibujar()
        {
            ...
            for (int i = 0; i < 62; i++)            //lazo que dibuja los puntos en la gráfica
            {
                if (Var.X[i] >= 320)
        ...
        void Valores()        //los valores de los puntos necesarios para hacer el grafico
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                if (Var.X[i + 1] >= 320)    //desplazamiento del eje de tiempo
                    Var.X[i + 1] = 0;
                else
...
//                    Var.Y[i] = Trama[i];
                Var.F = 9000 / Trama[1];
                Var.SP = Trama[2] + (float)Trama[3]/100;
